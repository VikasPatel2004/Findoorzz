...
import flatImagePlaceholder from '../../../assets/Flat.svg'; // Use an appropriate placeholder image

const LenderListingDetail = ({ listing }) => {
    return (
        <div className="container mx-auto flex flex-col justify-center items-center py-4 my-4">
            ...
            <div className="bg-white p-6 m-2 shadow-lg rounded-2xl w-full max-w-3xl">
                {listing.propertyImages && listing.propertyImages.length > 0 ? (
                    ...
                    <img src={flatImagePlaceholder} className="rounded-t-2xl w-full h-64 object-cover" alt="listing_image" />
                )}
                <div className="p-4">
                    ...
                    <div className="flex justify-center pt-3">
                        <button type="button" className="bg-yellow-400 text-white font-semibold px-5 py-2 rounded-md hover:bg-yellow-500 transition duration-300">Contact Owner</button>
                    </div>
                </div>
            </div>
        </div>
...
export default LenderListingDetail;

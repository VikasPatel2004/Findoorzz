...
function LandlordListingForm() {
    ...
    return (
        <div className="container mx-auto flex justify-center items-center min-h-screen my-6">
            <div className="w-full max-w-4xl p-8 bg-gray-50 rounded-lg shadow-md">
    ...
    Tell <span className="text-yellow-500  ">Us About</span> Your Room !!
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 bg-white p-6 rounded-lg">
                        <div className="flex items-center">
                            <h2 className="text-3xl ">Landlord Information</h2>
                        </div>
                        <div>
                    ...
                    {/* Property Details */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 bg-white p-6 rounded-md">
                        <div className="flex items-center">
                            <h2 className="text-3xl">Property Details</h2>
                        </div>
                        <div>
                            <div className="grid grid-cols-1 gap-4">
                                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 bg-white p-6 rounded-md">
                        <div className="flex items-center">
                            <h2 className="text-2xl">Restriction</h2>
                        </div>
                        <div>
                            <div className="flex items-center">
                                <input 
                                    ...
                                    onChange={handleChange} 
                                />
                                <label className="ml-2 text-gray-700">Independent</label>
                            </div>
                        </div>
                    </div>
